...
proc create_root_design { parentCell } {
  ...
  set LEDs_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 LEDs_0 ]
  ...
  # Create instance: gpio_player_pos, and set properties
  set gpio_player_pos [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_player_pos ]
  set_property -dict [list \
    CONFIG.C_ALL_OUTPUTS {1} \
    CONFIG.C_IS_DUAL {0} \
  ] $gpio_player_pos
  ...
  # Create instance: gpio_deugging, and set properties
  set gpio_deugging [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_deugging ]
  set_property CONFIG.C_ALL_INPUTS {1} $gpio_deugging


  # Create instance: GameIP_0, and set properties
  set GameIP_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:GameIP:1.0 GameIP_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net GameIP_0_HDMI [get_bd_intf_ports HDMI_0] [get_bd_intf_pins GameIP_0/HDMI]
  connect_bd_intf_net -intf_net GameIP_0_LEDs [get_bd_intf_ports LEDs_0] [get_bd_intf_pins GameIP_0/LEDs]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M02_AXI [get_bd_intf_pins microblaze_0_axi_periph/M02_AXI] [get_bd_intf_pins timer_usb_axi/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M03_AXI [get_bd_intf_pins microblaze_0_axi_periph/M03_AXI] [get_bd_intf_pins gpio_usb_int/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M04_AXI [get_bd_intf_pins microblaze_0_axi_periph/M04_AXI] [get_bd_intf_pins gpio_usb_rst/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M05_AXI [get_bd_intf_pins microblaze_0_axi_periph/M05_AXI] [get_bd_intf_pins gpio_player_pos/S_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M07_AXI [get_bd_intf_pins microblaze_0_axi_periph/M07_AXI] [get_bd_intf_pins GameIP_0/AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M08_AXI [get_bd_intf_pins microblaze_0_axi_periph/M08_AXI] [get_bd_intf_pins gpio_deugging/S_AXI]
  ...
  # Create port connections
  connect_bd_net -net GameIP_0_debugging [get_bd_pins GameIP_0/Hardware_to_software] [get_bd_pins gpio_deugging/gpio_io_i]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins timer_usb_axi/interrupt] [get_bd_pins microblaze_0_xlconcat/In1]
  ...
  connect_bd_net -net gpio_player_pos_gpio_io_o [get_bd_pins gpio_player_pos/gpio_io_o] [get_bd_pins GameIP_0/player_pos]
  connect_bd_net -net gpio_usb_int_ip2intc_irpt [get_bd_pins gpio_usb_int/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In2]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins timer_usb_axi/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins gpio_usb_int/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins gpio_usb_rst/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins gpio_player_pos/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins spi_usb/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins spi_usb/ext_spi_clk] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins gpio_deugging/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins GameIP_0/axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins timer_usb_axi/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins gpio_usb_int/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins gpio_usb_rst/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins gpio_player_pos/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins spi_usb/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins gpio_deugging/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins GameIP_0/axi_aresetn]
  connect_bd_net -net spi_usb_io0_o [get_bd_pins spi_usb/io0_o] [get_bd_ports usb_spi_mosi]
  connect_bd_net -net spi_usb_ip2intc_irpt [get_bd_pins spi_usb/ip2intc_irpt] [get_bd_pins microblaze_0_xlconcat/In3]
  connect_bd_net -net spi_usb_sck_o [get_bd_pins spi_usb/sck_o] [get_bd_ports usb_spi_sclk]
  connect_bd_net -net spi_usb_ss_o [get_bd_pins spi_usb/ss_o] [get_bd_ports usb_spi_ss]
  connect_bd_net -net usb_spi_miso_1 [get_bd_ports usb_spi_miso] [get_bd_pins spi_usb/io1_i]

  # Create address segments
  assign_bd_address -offset 0x44A10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs GameIP_0/AXI/AXI_reg] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_player_pos/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_deugging/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_usb_rst/S_AXI/Reg] -force
