...
HD_PWD='C:/Users/Abdullah/Lab_7/Lab_7.runs/mb_hdmi_ilmb_bram_if_cntlr_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_hdmi_ilmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_hdmi_ilmb_bram_if_cntlr_2.tcl
