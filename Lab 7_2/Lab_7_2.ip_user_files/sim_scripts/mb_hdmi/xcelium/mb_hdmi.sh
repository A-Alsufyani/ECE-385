...
#
# Script generated by Vivado on Sat Nov 04 09:17:19 -0500 2023
...
#
# Usage        : mb_hdmi.sh
#                mb_hdmi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mb_hdmi.sh [-reset_run]
#                mb_hdmi.sh [-reset_log]
#                mb_hdmi.sh [-help]
#
...
#                script (type 'mb_hdmi.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mb_hdmi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../Lab_7_2.gen/sources_1/bd/mb_hdmi/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../Lab_7_2.gen/sources_1/bd/mb_hdmi/ipshared/30ef" +incdir+"../../../../Lab_7_2.gen/sources_1/bd/mb_hdmi/ipshared/ec67/hdl" +incdir+"../../../../Lab_7_2.gen/sources_1/bd/mb_hdmi/ipshared/30ef" +incdir+"../../../../Lab_7_2.gen/sources_1/bd/mb_hdmi/ip/mb_hdmi_hdmi_text_controller_0_0/src/clk_wiz_0" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.mb_hdmi xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.mb_hdmi -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log mb_hdmi_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: mb_hdmi.sh [-step]\n\
Usage: mb_hdmi.sh [-lib_map_path]\n\
Usage: mb_hdmi.sh [-reset_run]\n\
Usage: mb_hdmi.sh [-reset_log]\n\
Usage: mb_hdmi.sh [-keep_index]\n\
